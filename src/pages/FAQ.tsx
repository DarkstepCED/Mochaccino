                        ...
                        <AnimatePresence>
                            ...
                            <motion.div 
                                ...
                                animate={{ 
                                    ...
                                    opacity: 1,
                                    transition: { 
                                        height: { duration: 0.4, ease: [0.04, 0.62, 0.23, 0.98] }, // Плавная пружина
                            ...
                            style={{ padding: "0 25px 25px 25px", overflow: "hidden" }} // ОБЯЗАТЕЛЬНО: скрывает текст, пока он "сжимается"
                        >
