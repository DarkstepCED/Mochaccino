export const s: any = {
    ...
    card: { width: "280px", padding: "40px 25px 30px", background: "rgba(255,255,255,0.06)", backdropFilter: "blur(20px)", borderRadius: "35px", border: "1px solid rgba(255,255,255,0.1)", display: "flex", flexDirection: "column", alignItems: "center", cursor: "pointer" },
    secretCard: { width: "280px", padding: "40px 25px 30px", background: "rgba(168,85,247,0.05)", backdropFilter: "blur(20px)", borderRadius: "35px", border: "1px solid rgba(168,85,247,0.3)", display: "flex", flexDirection: "column", alignItems: "center", boxShadow: "0 0 30px rgba(168,85,247,0.1)", cursor: "pointer" },
    ...
    socialTag: { padding: "10px 25px", background: "#6F4E37", color: "#FFFDD0", borderRadius: "15px", fontWeight: "900", fontSize: "13px", display: "flex", alignItems: "center", gap: "8px" }
}
